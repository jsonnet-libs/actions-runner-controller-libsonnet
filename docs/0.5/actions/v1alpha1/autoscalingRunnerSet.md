---
permalink: /0.5/actions/v1alpha1/autoscalingRunnerSet/
---
...
new returns an instance of AutoscalingRunnerSet
...
### fn spec.withRunnerGroup

```ts
withRunnerGroup(runnerGroup)
```



### fn spec.withRunnerScaleSetName

```ts
withRunnerScaleSetName(runnerScaleSetName)
```
