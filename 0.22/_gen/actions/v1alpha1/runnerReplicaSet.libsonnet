  ...
  spec: {
    ...
    template: {
      ...
      spec: {
        ...
        '#topologySpreadConstraint':: d.obj(help=''),
        ...
        '#withDnsConfig':: d.fn(help='', args=[d.arg(name='dnsConfig', type=d.T.array)]),
        withDnsConfig(dnsConfig): { spec+: { template+: { spec+: { dnsConfig: if std.isArray(v=dnsConfig) then dnsConfig else [dnsConfig] } } } },
        '#withDnsConfigMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dnsConfig', type=d.T.array)]),
        withDnsConfigMixin(dnsConfig): { spec+: { template+: { spec+: { dnsConfig+: if std.isArray(v=dnsConfig) then dnsConfig else [dnsConfig] } } } },
        ...
        '#withTopologySpreadConstraint':: d.fn(help='', args=[d.arg(name='topologySpreadConstraint', type=d.T.array)]),
        withTopologySpreadConstraint(topologySpreadConstraint): { spec+: { template+: { spec+: { topologySpreadConstraint: if std.isArray(v=topologySpreadConstraint) then topologySpreadConstraint else [topologySpreadConstraint] } } } },
        '#withTopologySpreadConstraintMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='topologySpreadConstraint', type=d.T.array)]),
        withTopologySpreadConstraintMixin(topologySpreadConstraint): { spec+: { template+: { spec+: { topologySpreadConstraint+: if std.isArray(v=topologySpreadConstraint) then topologySpreadConstraint else [topologySpreadConstraint] } } } },
