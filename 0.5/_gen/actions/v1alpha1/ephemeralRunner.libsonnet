{
  ...
  '#':: d.pkg(name='ephemeralRunner', url='', help='"EphemeralRunner is the Schema for the ephemeralrunners API"'),
  ...
  '#new':: d.fn(help='new returns an instance of EphemeralRunner', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'actions.github.com/v1alpha1',
    kind: 'EphemeralRunner',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"EphemeralRunnerSpec defines the desired state of EphemeralRunner"'),
  spec: {
    ...
    githubServerTLS: {
      ...
      certificateFrom: {
        ...
        configMapKeyRef: {
          ...
          withKey(key): { spec+: { githubServerTLS+: { certificateFrom+: { configMapKeyRef+: { key: key } } } } },
          ...
          withName(name): { spec+: { githubServerTLS+: { certificateFrom+: { configMapKeyRef+: { name: name } } } } },
          ...
          withOptional(optional): { spec+: { githubServerTLS+: { certificateFrom+: { configMapKeyRef+: { optional: optional } } } } },
        },
      },
    },
    ...
    metadata: {
      ...
      withFinalizers(finalizers): { spec+: { metadata+: { finalizers: if std.isArray(v=finalizers) then finalizers else [finalizers] } } },
      '#withFinalizersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='finalizers', type=d.T.array)]),
      withFinalizersMixin(finalizers): { spec+: { metadata+: { finalizers+: if std.isArray(v=finalizers) then finalizers else [finalizers] } } },
      ...
      withName(name): { spec+: { metadata+: { name: name } } },
      '#withNamespace':: d.fn(help='', args=[d.arg(name='namespace', type=d.T.string)]),
      withNamespace(namespace): { spec+: { metadata+: { namespace: namespace } } },
    },
    '#proxy':: d.obj(help=''),
    proxy: {
      '#http':: d.obj(help=''),
      http: {
        ...
        withCredentialSecretRef(credentialSecretRef): { spec+: { proxy+: { http+: { credentialSecretRef: credentialSecretRef } } } },
        '#withUrl':: d.fn(help='"Required"', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { proxy+: { http+: { url: url } } } },
      },
      '#https':: d.obj(help=''),
      https: {
        '#withCredentialSecretRef':: d.fn(help='', args=[d.arg(name='credentialSecretRef', type=d.T.string)]),
        withCredentialSecretRef(credentialSecretRef): { spec+: { proxy+: { https+: { credentialSecretRef: credentialSecretRef } } } },
        '#withUrl':: d.fn(help='"Required"', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { proxy+: { https+: { url: url } } } },
      },
    ...
    spec: {
      ...
      affinity: {
        ...
        nodeAffinity: {
          ...
          requiredDuringSchedulingIgnoredDuringExecution: {
            ...
            withNodeSelectorTerms(nodeSelectorTerms): { spec+: { spec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } },
            ...
            withNodeSelectorTermsMixin(nodeSelectorTerms): { spec+: { spec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } },
          },
          ...
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { spec+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
        ...
        podAffinity: {
          ...
          withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { spec+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the node(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { spec+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          ...
          withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { spec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
          ...
          withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { spec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
        ...
        podAntiAffinity: {
          ...
          withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { spec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the anti-affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling anti-affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the node(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { spec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          ...
          withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { spec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"If the anti-affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the anti-affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAffinityTerm are intersected, i.e. all terms must be satisfied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { spec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
      },
      ...
      dnsConfig: {
        ...
        withNameservers(nameservers): { spec+: { spec+: { dnsConfig+: { nameservers: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } },
        ...
        withNameserversMixin(nameservers): { spec+: { spec+: { dnsConfig+: { nameservers+: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } },
        ...
        withOptions(options): { spec+: { spec+: { dnsConfig+: { options: if std.isArray(v=options) then options else [options] } } } },
        ...
        withOptionsMixin(options): { spec+: { spec+: { dnsConfig+: { options+: if std.isArray(v=options) then options else [options] } } } },
        ...
        withSearches(searches): { spec+: { spec+: { dnsConfig+: { searches: if std.isArray(v=searches) then searches else [searches] } } } },
        ...
        withSearchesMixin(searches): { spec+: { spec+: { dnsConfig+: { searches+: if std.isArray(v=searches) then searches else [searches] } } } },
      },
      ...
      os: {
        ...
        withName(name): { spec+: { spec+: { os+: { name: name } } } },
      },
      ...
      securityContext: {
        ...
        seLinuxOptions: {
          '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
          withLevel(level): { spec+: { spec+: { securityContext+: { seLinuxOptions+: { level: level } } } } },
          '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
          withRole(role): { spec+: { spec+: { securityContext+: { seLinuxOptions+: { role: role } } } } },
          '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { spec+: { securityContext+: { seLinuxOptions+: { type: type } } } } },
          '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
          withUser(user): { spec+: { spec+: { securityContext+: { seLinuxOptions+: { user: user } } } } },
        },
        ...
        seccompProfile: {
          '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used. The profile must be preconfigured on the node to work. Must be a descending path, relative to the kubelet's configured seccomp profile location. Must only be set if type is \\\"Localhost\\\".\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
          withLocalhostProfile(localhostProfile): { spec+: { spec+: { securityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } },
          '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied. Valid options are: \\n Localhost - a profile defined in a file on the node should be used. RuntimeDefault - the container runtime default profile should be used. Unconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { spec+: { securityContext+: { seccompProfile+: { type: type } } } } },
        },
        ...
        windowsOptions: {
          '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook (https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the GMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
          withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { spec+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } },
          '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
          withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { spec+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } },
          '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container. This field is alpha-level and will only be honored by components that enable the WindowsHostProcessContainers feature flag. Setting this field without the feature flag will result in errors when validating the Pod. All of a Pod's containers must have the same effective HostProcess value (it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).  In addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
          withHostProcess(hostProcess): { spec+: { spec+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } },
          '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
          withRunAsUserName(runAsUserName): { spec+: { spec+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } },
        },
        ...
        withFsGroup(fsGroup): { spec+: { spec+: { securityContext+: { fsGroup: fsGroup } } } },
        ...
        withFsGroupChangePolicy(fsGroupChangePolicy): { spec+: { spec+: { securityContext+: { fsGroupChangePolicy: fsGroupChangePolicy } } } },
        ...
        withRunAsGroup(runAsGroup): { spec+: { spec+: { securityContext+: { runAsGroup: runAsGroup } } } },
        ...
        withRunAsNonRoot(runAsNonRoot): { spec+: { spec+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } },
        '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process. Defaults to user specified in image metadata if unspecified. May also be set in SecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence for that container. Note that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
        withRunAsUser(runAsUser): { spec+: { spec+: { securityContext+: { runAsUser: runAsUser } } } },
        ...
        withSupplementalGroups(supplementalGroups): { spec+: { spec+: { securityContext+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } },
        ...
        withSupplementalGroupsMixin(supplementalGroups): { spec+: { spec+: { securityContext+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } },
        ...
        withSysctls(sysctls): { spec+: { spec+: { securityContext+: { sysctls: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } },
        ...
        withSysctlsMixin(sysctls): { spec+: { spec+: { securityContext+: { sysctls+: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } },
      },
      ...
      withActiveDeadlineSeconds(activeDeadlineSeconds): { spec+: { spec+: { activeDeadlineSeconds: activeDeadlineSeconds } } },
      ...
      withAutomountServiceAccountToken(automountServiceAccountToken): { spec+: { spec+: { automountServiceAccountToken: automountServiceAccountToken } } },
      ...
      withContainers(containers): { spec+: { spec+: { containers: if std.isArray(v=containers) then containers else [containers] } } },
      ...
      withContainersMixin(containers): { spec+: { spec+: { containers+: if std.isArray(v=containers) then containers else [containers] } } },
      ...
      withDnsPolicy(dnsPolicy): { spec+: { spec+: { dnsPolicy: dnsPolicy } } },
      ...
      withEnableServiceLinks(enableServiceLinks): { spec+: { spec+: { enableServiceLinks: enableServiceLinks } } },
      ...
      withEphemeralContainers(ephemeralContainers): { spec+: { spec+: { ephemeralContainers: if std.isArray(v=ephemeralContainers) then ephemeralContainers else [ephemeralContainers] } } },
      ...
      withEphemeralContainersMixin(ephemeralContainers): { spec+: { spec+: { ephemeralContainers+: if std.isArray(v=ephemeralContainers) then ephemeralContainers else [ephemeralContainers] } } },
      ...
      withHostAliases(hostAliases): { spec+: { spec+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } },
      ...
      withHostAliasesMixin(hostAliases): { spec+: { spec+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } },
      '#withHostIPC':: d.fn(help="\"Use the host's ipc namespace. Optional: Default to false.\"", args=[d.arg(name='hostIPC', type=d.T.boolean)]),
      withHostIPC(hostIPC): { spec+: { spec+: { hostIPC: hostIPC } } },
      ...
      withHostUsers(hostUsers): { spec+: { spec+: { hostUsers: hostUsers } } },
      ...
      withHostname(hostname): { spec+: { spec+: { hostname: hostname } } },
      ...
      withImagePullSecrets(imagePullSecrets): { spec+: { spec+: { imagePullSecrets: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } },
      ...
      withImagePullSecretsMixin(imagePullSecrets): { spec+: { spec+: { imagePullSecrets+: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } },
      ...
      withInitContainers(initContainers): { spec+: { spec+: { initContainers: if std.isArray(v=initContainers) then initContainers else [initContainers] } } },
      ...
      withInitContainersMixin(initContainers): { spec+: { spec+: { initContainers+: if std.isArray(v=initContainers) then initContainers else [initContainers] } } },
      ...
      withNodeName(nodeName): { spec+: { spec+: { nodeName: nodeName } } },
      ...
      withNodeSelector(nodeSelector): { spec+: { spec+: { nodeSelector: nodeSelector } } },
      ...
      withNodeSelectorMixin(nodeSelector): { spec+: { spec+: { nodeSelector+: nodeSelector } } },
      ...
      withOverhead(overhead): { spec+: { spec+: { overhead: overhead } } },
      ...
      withOverheadMixin(overhead): { spec+: { spec+: { overhead+: overhead } } },
      ...
      withPreemptionPolicy(preemptionPolicy): { spec+: { spec+: { preemptionPolicy: preemptionPolicy } } },
      ...
      withPriority(priority): { spec+: { spec+: { priority: priority } } },
      ...
      withPriorityClassName(priorityClassName): { spec+: { spec+: { priorityClassName: priorityClassName } } },
      ...
      withReadinessGates(readinessGates): { spec+: { spec+: { readinessGates: if std.isArray(v=readinessGates) then readinessGates else [readinessGates] } } },
      ...
      withReadinessGatesMixin(readinessGates): { spec+: { spec+: { readinessGates+: if std.isArray(v=readinessGates) then readinessGates else [readinessGates] } } },
      ...
      withResourceClaims(resourceClaims): { spec+: { spec+: { resourceClaims: if std.isArray(v=resourceClaims) then resourceClaims else [resourceClaims] } } },
      ...
      withResourceClaimsMixin(resourceClaims): { spec+: { spec+: { resourceClaims+: if std.isArray(v=resourceClaims) then resourceClaims else [resourceClaims] } } },
      ...
      withRestartPolicy(restartPolicy): { spec+: { spec+: { restartPolicy: restartPolicy } } },
      ...
      withRuntimeClassName(runtimeClassName): { spec+: { spec+: { runtimeClassName: runtimeClassName } } },
      ...
      withSchedulerName(schedulerName): { spec+: { spec+: { schedulerName: schedulerName } } },
      ...
      withSchedulingGates(schedulingGates): { spec+: { spec+: { schedulingGates: if std.isArray(v=schedulingGates) then schedulingGates else [schedulingGates] } } },
      ...
      withSchedulingGatesMixin(schedulingGates): { spec+: { spec+: { schedulingGates+: if std.isArray(v=schedulingGates) then schedulingGates else [schedulingGates] } } },
      ...
      withServiceAccount(serviceAccount): { spec+: { spec+: { serviceAccount: serviceAccount } } },
      ...
      withServiceAccountName(serviceAccountName): { spec+: { spec+: { serviceAccountName: serviceAccountName } } },
      ...
      withSetHostnameAsFQDN(setHostnameAsFQDN): { spec+: { spec+: { setHostnameAsFQDN: setHostnameAsFQDN } } },
      ...
      withShareProcessNamespace(shareProcessNamespace): { spec+: { spec+: { shareProcessNamespace: shareProcessNamespace } } },
      ...
      withSubdomain(subdomain): { spec+: { spec+: { subdomain: subdomain } } },
      ...
      withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { spec+: { spec+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } },
      '#withTolerations':: d.fn(help="\"If specified, the pod's tolerations.\"", args=[d.arg(name='tolerations', type=d.T.array)]),
      withTolerations(tolerations): { spec+: { spec+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } } },
      ...
      withTolerationsMixin(tolerations): { spec+: { spec+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } } },
      ...
      withTopologySpreadConstraints(topologySpreadConstraints): { spec+: { spec+: { topologySpreadConstraints: if std.isArray(v=topologySpreadConstraints) then topologySpreadConstraints else [topologySpreadConstraints] } } },
      ...
      withTopologySpreadConstraintsMixin(topologySpreadConstraints): { spec+: { spec+: { topologySpreadConstraints+: if std.isArray(v=topologySpreadConstraints) then topologySpreadConstraints else [topologySpreadConstraints] } } },
      ...
      withVolumes(volumes): { spec+: { spec+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } },
      ...
      withVolumesMixin(volumes): { spec+: { spec+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } },
    },
    '#withGithubConfigSecret':: d.fn(help='', args=[d.arg(name='githubConfigSecret', type=d.T.string)]),
    withGithubConfigSecret(githubConfigSecret): { spec+: { githubConfigSecret: githubConfigSecret } },
    '#withGithubConfigUrl':: d.fn(help='', args=[d.arg(name='githubConfigUrl', type=d.T.string)]),
    withGithubConfigUrl(githubConfigUrl): { spec+: { githubConfigUrl: githubConfigUrl } },
    '#withProxySecretRef':: d.fn(help='', args=[d.arg(name='proxySecretRef', type=d.T.string)]),
    withProxySecretRef(proxySecretRef): { spec+: { proxySecretRef: proxySecretRef } },
    '#withRunnerScaleSetId':: d.fn(help='', args=[d.arg(name='runnerScaleSetId', type=d.T.integer)]),
    withRunnerScaleSetId(runnerScaleSetId): { spec+: { runnerScaleSetId: runnerScaleSetId } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
