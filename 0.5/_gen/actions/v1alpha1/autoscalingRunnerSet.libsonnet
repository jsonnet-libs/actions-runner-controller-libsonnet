{
  ...
  '#':: d.pkg(name='autoscalingRunnerSet', url='', help='"AutoscalingRunnerSet is the Schema for the autoscalingrunnersets API"'),
  ...
  '#new':: d.fn(help='new returns an instance of AutoscalingRunnerSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'actions.github.com/v1alpha1',
    kind: 'AutoscalingRunnerSet',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"AutoscalingRunnerSetSpec defines the desired state of AutoscalingRunnerSet"'),
  spec: {
    ...
    '#withMaxRunners':: d.fn(help='', args=[d.arg(name='maxRunners', type=d.T.integer)]),
    withMaxRunners(maxRunners): { spec+: { maxRunners: maxRunners } },
    '#withMinRunners':: d.fn(help='', args=[d.arg(name='minRunners', type=d.T.integer)]),
    withMinRunners(minRunners): { spec+: { minRunners: minRunners } },
    '#withRunnerGroup':: d.fn(help='', args=[d.arg(name='runnerGroup', type=d.T.string)]),
    withRunnerGroup(runnerGroup): { spec+: { runnerGroup: runnerGroup } },
    '#withRunnerScaleSetName':: d.fn(help='', args=[d.arg(name='runnerScaleSetName', type=d.T.string)]),
    withRunnerScaleSetName(runnerScaleSetName): { spec+: { runnerScaleSetName: runnerScaleSetName } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
