{
  ...
  spec: {
    ...
    withDnsConfig(dnsConfig): { spec+: { dnsConfig: if std.isArray(v=dnsConfig) then dnsConfig else [dnsConfig] } },
    ...
    withDnsConfigMixin(dnsConfig): { spec+: { dnsConfig+: if std.isArray(v=dnsConfig) then dnsConfig else [dnsConfig] } },
    ...
    withTopologySpreadConstraint(topologySpreadConstraint): { spec+: { topologySpreadConstraint: if std.isArray(v=topologySpreadConstraint) then topologySpreadConstraint else [topologySpreadConstraint] } },
    ...
    withTopologySpreadConstraintMixin(topologySpreadConstraint): { spec+: { topologySpreadConstraint+: if std.isArray(v=topologySpreadConstraint) then topologySpreadConstraint else [topologySpreadConstraint] } },
