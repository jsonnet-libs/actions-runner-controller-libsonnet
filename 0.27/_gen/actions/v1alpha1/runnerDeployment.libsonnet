{
  ...
  '#':: d.pkg(name='runnerDeployment', url='', help='"RunnerDeployment is the Schema for the runnerdeployments API"'),
  ...
  '#new':: d.fn(help='new returns an instance of RunnerDeployment', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'actions.summerwind.dev/v1alpha1',
    kind: 'RunnerDeployment',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RunnerDeploymentSpec defines the desired state of RunnerDeployment"'),
  spec: {
