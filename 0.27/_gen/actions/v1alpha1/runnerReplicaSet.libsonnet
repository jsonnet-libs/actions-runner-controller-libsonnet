{
  ...
  '#':: d.pkg(name='runnerReplicaSet', url='', help='"RunnerReplicaSet is the Schema for the runnerreplicasets API"'),
  ...
  '#new':: d.fn(help='new returns an instance of RunnerReplicaSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'actions.summerwind.dev/v1alpha1',
    kind: 'RunnerReplicaSet',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RunnerReplicaSetSpec defines the desired state of RunnerReplicaSet"'),
  spec: {
    ...
    template: {
      ...
      '#spec':: d.obj(help='"RunnerSpec defines the desired state of Runner"'),
      spec: {
        ...
        '#dockerdContainerResources':: d.obj(help='"ResourceRequirements describes the compute resource requirements."'),
        dockerdContainerResources: {
          ...
          '#withClaims':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. \\n This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. \\n This field is immutable. It can only be set for containers."', args=[d.arg(name='claims', type=d.T.array)]),
          withClaims(claims): { spec+: { template+: { spec+: { dockerdContainerResources+: { claims: if std.isArray(v=claims) then claims else [claims] } } } } },
          '#withClaimsMixin':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. \\n This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. \\n This field is immutable. It can only be set for containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
          withClaimsMixin(claims): { spec+: { template+: { spec+: { dockerdContainerResources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } } } },
          '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
          withLimits(limits): { spec+: { template+: { spec+: { dockerdContainerResources+: { limits: limits } } } } },
          '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
          withLimitsMixin(limits): { spec+: { template+: { spec+: { dockerdContainerResources+: { limits+: limits } } } } },
          '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
          withRequests(requests): { spec+: { template+: { spec+: { dockerdContainerResources+: { requests: requests } } } } },
          '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
          withRequestsMixin(requests): { spec+: { template+: { spec+: { dockerdContainerResources+: { requests+: requests } } } } },
        },
        '#env':: d.obj(help=''),
        env: {
          '#valueFrom':: d.obj(help="\"Source for the environment variable's value. Cannot be used if value is not empty.\""),
        ...
        githubAPICredentialsFrom: {
          ...
          secretRef: {
            '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { template+: { spec+: { githubAPICredentialsFrom+: { secretRef+: { name: name } } } } } },
          },
        },
        ...
        '#withContainerMode':: d.fn(help='', args=[d.arg(name='containerMode', type=d.T.string)]),
        withContainerMode(containerMode): { spec+: { template+: { spec+: { containerMode: containerMode } } } },
        ...
        '#withDockerEnabled':: d.fn(help='', args=[d.arg(name='dockerEnabled', type=d.T.boolean)]),
        withDockerEnabled(dockerEnabled): { spec+: { template+: { spec+: { dockerEnabled: dockerEnabled } } } },
        '#withDockerEnv':: d.fn(help='', args=[d.arg(name='dockerEnv', type=d.T.array)]),
        withDockerEnv(dockerEnv): { spec+: { template+: { spec+: { dockerEnv: if std.isArray(v=dockerEnv) then dockerEnv else [dockerEnv] } } } },
        '#withDockerEnvMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dockerEnv', type=d.T.array)]),
        withDockerEnvMixin(dockerEnv): { spec+: { template+: { spec+: { dockerEnv+: if std.isArray(v=dockerEnv) then dockerEnv else [dockerEnv] } } } },
        '#withDockerMTU':: d.fn(help='', args=[d.arg(name='dockerMTU', type=d.T.integer)]),
        withDockerMTU(dockerMTU): { spec+: { template+: { spec+: { dockerMTU: dockerMTU } } } },
        '#withDockerRegistryMirror':: d.fn(help='', args=[d.arg(name='dockerRegistryMirror', type=d.T.string)]),
        withDockerRegistryMirror(dockerRegistryMirror): { spec+: { template+: { spec+: { dockerRegistryMirror: dockerRegistryMirror } } } },
        '#withDockerVarRunVolumeSizeLimit':: d.fn(help='', args=[d.arg(name='dockerVarRunVolumeSizeLimit', type=d.T.any)]),
        withDockerVarRunVolumeSizeLimit(dockerVarRunVolumeSizeLimit): { spec+: { template+: { spec+: { dockerVarRunVolumeSizeLimit: dockerVarRunVolumeSizeLimit } } } },
        '#withDockerVolumeMounts':: d.fn(help='', args=[d.arg(name='dockerVolumeMounts', type=d.T.array)]),
        withDockerVolumeMounts(dockerVolumeMounts): { spec+: { template+: { spec+: { dockerVolumeMounts: if std.isArray(v=dockerVolumeMounts) then dockerVolumeMounts else [dockerVolumeMounts] } } } },
        '#withDockerVolumeMountsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dockerVolumeMounts', type=d.T.array)]),
        withDockerVolumeMountsMixin(dockerVolumeMounts): { spec+: { template+: { spec+: { dockerVolumeMounts+: if std.isArray(v=dockerVolumeMounts) then dockerVolumeMounts else [dockerVolumeMounts] } } } },
        '#withDockerdWithinRunnerContainer':: d.fn(help='', args=[d.arg(name='dockerdWithinRunnerContainer', type=d.T.boolean)]),
        withDockerdWithinRunnerContainer(dockerdWithinRunnerContainer): { spec+: { template+: { spec+: { dockerdWithinRunnerContainer: dockerdWithinRunnerContainer } } } },
        ...
        '#withEnterprise':: d.fn(help='', args=[d.arg(name='enterprise', type=d.T.string)]),
        withEnterprise(enterprise): { spec+: { template+: { spec+: { enterprise: enterprise } } } },
        '#withEnv':: d.fn(help='', args=[d.arg(name='env', type=d.T.array)]),
        withEnv(env): { spec+: { template+: { spec+: { env: if std.isArray(v=env) then env else [env] } } } },
        '#withEnvFrom':: d.fn(help='', args=[d.arg(name='envFrom', type=d.T.array)]),
        withEnvFrom(envFrom): { spec+: { template+: { spec+: { envFrom: if std.isArray(v=envFrom) then envFrom else [envFrom] } } } },
        '#withEnvFromMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envFrom', type=d.T.array)]),
        withEnvFromMixin(envFrom): { spec+: { template+: { spec+: { envFrom+: if std.isArray(v=envFrom) then envFrom else [envFrom] } } } },
        '#withEnvMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
        withEnvMixin(env): { spec+: { template+: { spec+: { env+: if std.isArray(v=env) then env else [env] } } } },
        '#withEphemeral':: d.fn(help='', args=[d.arg(name='ephemeral', type=d.T.boolean)]),
        withEphemeral(ephemeral): { spec+: { template+: { spec+: { ephemeral: ephemeral } } } },
        ...
        withGroup(group): { spec+: { template+: { spec+: { group: group } } } },
        ...
        withImage(image): { spec+: { template+: { spec+: { image: image } } } },
        ...
        withImagePullPolicy(imagePullPolicy): { spec+: { template+: { spec+: { imagePullPolicy: imagePullPolicy } } } },
        ...
        withLabels(labels): { spec+: { template+: { spec+: { labels: if std.isArray(v=labels) then labels else [labels] } } } },
        '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.array)]),
        withLabelsMixin(labels): { spec+: { template+: { spec+: { labels+: if std.isArray(v=labels) then labels else [labels] } } } },
        ...
        withOrganization(organization): { spec+: { template+: { spec+: { organization: organization } } } },
        ...
        withRepository(repository): { spec+: { template+: { spec+: { repository: repository } } } },
        '#withRuntimeClassName':: d.fn(help='"RuntimeClassName is the container runtime configuration that containers should run under. More info: https://kubernetes.io/docs/concepts/containers/runtime-class"', args=[d.arg(name='runtimeClassName', type=d.T.string)]),
        ...
        '#withSidecarContainers':: d.fn(help='', args=[d.arg(name='sidecarContainers', type=d.T.array)]),
        withSidecarContainers(sidecarContainers): { spec+: { template+: { spec+: { sidecarContainers: if std.isArray(v=sidecarContainers) then sidecarContainers else [sidecarContainers] } } } },
        '#withSidecarContainersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sidecarContainers', type=d.T.array)]),
        withSidecarContainersMixin(sidecarContainers): { spec+: { template+: { spec+: { sidecarContainers+: if std.isArray(v=sidecarContainers) then sidecarContainers else [sidecarContainers] } } } },
        ...
        withVolumeMounts(volumeMounts): { spec+: { template+: { spec+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
        '#withVolumeMountsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumeMounts', type=d.T.array)]),
        withVolumeMountsMixin(volumeMounts): { spec+: { template+: { spec+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
        '#withVolumeSizeLimit':: d.fn(help='', args=[d.arg(name='volumeSizeLimit', type=d.T.any)]),
        withVolumeSizeLimit(volumeSizeLimit): { spec+: { template+: { spec+: { volumeSizeLimit: volumeSizeLimit } } } },
        '#withVolumeStorageMedium':: d.fn(help='', args=[d.arg(name='volumeStorageMedium', type=d.T.string)]),
        withVolumeStorageMedium(volumeStorageMedium): { spec+: { template+: { spec+: { volumeStorageMedium: volumeStorageMedium } } } },
        ...
        '#withWorkDir':: d.fn(help='', args=[d.arg(name='workDir', type=d.T.string)]),
        withWorkDir(workDir): { spec+: { template+: { spec+: { workDir: workDir } } } },
        '#workVolumeClaimTemplate':: d.obj(help=''),
        workVolumeClaimTemplate: {
          ...
          resources: {
            ...
            '#withClaims':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. \\n This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. \\n This field is immutable. It can only be set for containers."', args=[d.arg(name='claims', type=d.T.array)]),
            withClaims(claims): { spec+: { template+: { spec+: { workVolumeClaimTemplate+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } } } } },
            '#withClaimsMixin':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. \\n This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. \\n This field is immutable. It can only be set for containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
            withClaimsMixin(claims): { spec+: { template+: { spec+: { workVolumeClaimTemplate+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } } } } },
            '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
            withLimits(limits): { spec+: { template+: { spec+: { workVolumeClaimTemplate+: { resources+: { limits: limits } } } } } },
            '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
            withLimitsMixin(limits): { spec+: { template+: { spec+: { workVolumeClaimTemplate+: { resources+: { limits+: limits } } } } } },
            '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
            withRequests(requests): { spec+: { template+: { spec+: { workVolumeClaimTemplate+: { resources+: { requests: requests } } } } } },
            '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
            withRequestsMixin(requests): { spec+: { template+: { spec+: { workVolumeClaimTemplate+: { resources+: { requests+: requests } } } } } },
          },
          '#withAccessModes':: d.fn(help='', args=[d.arg(name='accessModes', type=d.T.array)]),
          withAccessModes(accessModes): { spec+: { template+: { spec+: { workVolumeClaimTemplate+: { accessModes: if std.isArray(v=accessModes) then accessModes else [accessModes] } } } } },
          '#withAccessModesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='accessModes', type=d.T.array)]),
          withAccessModesMixin(accessModes): { spec+: { template+: { spec+: { workVolumeClaimTemplate+: { accessModes+: if std.isArray(v=accessModes) then accessModes else [accessModes] } } } } },
          '#withStorageClassName':: d.fn(help='', args=[d.arg(name='storageClassName', type=d.T.string)]),
          withStorageClassName(storageClassName): { spec+: { template+: { spec+: { workVolumeClaimTemplate+: { storageClassName: storageClassName } } } } },
        },
      },
    },
    '#withEffectiveTime':: d.fn(help='"EffectiveTime is the time the upstream controller requested to sync Replicas. It is usually populated by the webhook-based autoscaler via HRA and RunnerDeployment. The value is used to prevent runnerreplicaset controller from unnecessarily recreating ephemeral runners based on potentially outdated Replicas value."', args=[d.arg(name='effectiveTime', type=d.T.string)]),
    withEffectiveTime(effectiveTime): { spec+: { effectiveTime: effectiveTime } },
