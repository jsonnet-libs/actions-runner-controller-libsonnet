{
  ...
  '#':: d.pkg(name='runner', url='', help='"Runner is the Schema for the runners API"'),
  ...
  '#new':: d.fn(help='new returns an instance of Runner', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    dockerdContainerResources: {
      ...
      '#withClaims':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. \\n This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. \\n This field is immutable. It can only be set for containers."', args=[d.arg(name='claims', type=d.T.array)]),
      withClaims(claims): { spec+: { dockerdContainerResources+: { claims: if std.isArray(v=claims) then claims else [claims] } } },
      '#withClaimsMixin':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. \\n This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. \\n This field is immutable. It can only be set for containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
      withClaimsMixin(claims): { spec+: { dockerdContainerResources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } },
      '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
      withLimits(limits): { spec+: { dockerdContainerResources+: { limits: limits } } },
      '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
      withLimitsMixin(limits): { spec+: { dockerdContainerResources+: { limits+: limits } } },
      '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
      withRequests(requests): { spec+: { dockerdContainerResources+: { requests: requests } } },
      '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
      withRequestsMixin(requests): { spec+: { dockerdContainerResources+: { requests+: requests } } },
    },
    '#env':: d.obj(help=''),
    env: {
      '#valueFrom':: d.obj(help="\"Source for the environment variable's value. Cannot be used if value is not empty.\""),
    ...
    withDockerEnv(dockerEnv): { spec+: { dockerEnv: if std.isArray(v=dockerEnv) then dockerEnv else [dockerEnv] } },
    ...
    withDockerEnvMixin(dockerEnv): { spec+: { dockerEnv+: if std.isArray(v=dockerEnv) then dockerEnv else [dockerEnv] } },
    ...
    withDockerVolumeMounts(dockerVolumeMounts): { spec+: { dockerVolumeMounts: if std.isArray(v=dockerVolumeMounts) then dockerVolumeMounts else [dockerVolumeMounts] } },
    ...
    withDockerVolumeMountsMixin(dockerVolumeMounts): { spec+: { dockerVolumeMounts+: if std.isArray(v=dockerVolumeMounts) then dockerVolumeMounts else [dockerVolumeMounts] } },
    ...
    withSidecarContainers(sidecarContainers): { spec+: { sidecarContainers: if std.isArray(v=sidecarContainers) then sidecarContainers else [sidecarContainers] } },
    ...
    withSidecarContainersMixin(sidecarContainers): { spec+: { sidecarContainers+: if std.isArray(v=sidecarContainers) then sidecarContainers else [sidecarContainers] } },
