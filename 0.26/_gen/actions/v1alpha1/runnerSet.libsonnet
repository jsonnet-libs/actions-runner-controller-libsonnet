{
  ...
  '#':: d.pkg(name='runnerSet', url='', help='"RunnerSet is the Schema for the runnersets API"'),
  ...
  '#new':: d.fn(help='new returns an instance of RunnerSet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'actions.summerwind.dev/v1alpha1',
    kind: 'RunnerSet',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RunnerSetSpec defines the desired state of RunnerSet"'),
  spec: {
    ...
    '#selector':: d.obj(help="\"selector is a label query over pods that should match the replica count. It must match the pod template's labels. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors\""),
    selector: {
    ...
    '#template':: d.obj(help='"template is the object that describes the pod that will be created if insufficient replicas are detected. Each pod stamped out by the StatefulSet will fulfill this Template, but have a unique identity from the rest of the StatefulSet."'),
    template: {
    ...
    '#updateStrategy':: d.obj(help='"updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template."'),
    updateStrategy: {
      '#rollingUpdate':: d.obj(help='"RollingUpdate is used to communicate parameters when Type is RollingUpdateStatefulSetStrategyType."'),
      rollingUpdate: {
        '#withMaxUnavailable':: d.fn(help='"The maximum number of pods that can be unavailable during the update. Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%). Absolute number is calculated from percentage by rounding up. This can not be 0. Defaults to 1. This field is alpha-level and is only honored by servers that enable the MaxUnavailableStatefulSet feature. The field applies to all pods in the range 0 to Replicas-1. That means if there is any unavailable pod in the range 0 to Replicas-1, it will be counted towards MaxUnavailable."', args=[d.arg(name='maxUnavailable', type=d.T.any)]),
    ...
    volumeClaimTemplates: {
      ...
      status: {
        ...
        withAccessModes(accessModes): { status+: { accessModes: if std.isArray(v=accessModes) then accessModes else [accessModes] } },
        ...
        withAccessModesMixin(accessModes): { status+: { accessModes+: if std.isArray(v=accessModes) then accessModes else [accessModes] } },
        ...
        withAllocatedResources(allocatedResources): { status+: { allocatedResources: allocatedResources } },
        ...
        withAllocatedResourcesMixin(allocatedResources): { status+: { allocatedResources+: allocatedResources } },
        ...
        withCapacity(capacity): { status+: { capacity: capacity } },
        ...
        withCapacityMixin(capacity): { status+: { capacity+: capacity } },
        ...
        withConditions(conditions): { status+: { conditions: if std.isArray(v=conditions) then conditions else [conditions] } },
        ...
        withConditionsMixin(conditions): { status+: { conditions+: if std.isArray(v=conditions) then conditions else [conditions] } },
        '#withPhase':: d.fn(help='"phase represents the current phase of PersistentVolumeClaim."', args=[d.arg(name='phase', type=d.T.string)]),
        withPhase(phase): { status+: { phase: phase } },
        ...
        withResizeStatus(resizeStatus): { status+: { resizeStatus: resizeStatus } },
      },
    ...
    withContainerMode(containerMode): { spec+: { containerMode: containerMode } },
    '#withDockerEnabled':: d.fn(help='', args=[d.arg(name='dockerEnabled', type=d.T.boolean)]),
    withDockerEnabled(dockerEnabled): { spec+: { dockerEnabled: dockerEnabled } },
    ...
    withEnterprise(enterprise): { spec+: { enterprise: enterprise } },
    '#withEphemeral':: d.fn(help='', args=[d.arg(name='ephemeral', type=d.T.boolean)]),
    withEphemeral(ephemeral): { spec+: { ephemeral: ephemeral } },
    ...
    '#withReplicas':: d.fn(help='"replicas is the desired number of replicas of the given Template. These are replicas in the sense that they are instantiations of the same Template, but individual replicas also have a consistent identity. If unspecified, defaults to 1. TODO: Consider a rename of this field."', args=[d.arg(name='replicas', type=d.T.integer)]),
    ...
    withVolumeSizeLimit(volumeSizeLimit): { spec+: { volumeSizeLimit: volumeSizeLimit } },
    '#withVolumeStorageMedium':: d.fn(help='', args=[d.arg(name='volumeStorageMedium', type=d.T.string)]),
    withVolumeStorageMedium(volumeStorageMedium): { spec+: { volumeStorageMedium: volumeStorageMedium } },
    '#withWorkDir':: d.fn(help='', args=[d.arg(name='workDir', type=d.T.string)]),
    withWorkDir(workDir): { spec+: { workDir: workDir } },
    ...
    workVolumeClaimTemplate: {
      ...
      resources: {
        ...
        '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
        withLimitsMixin(limits): { spec+: { workVolumeClaimTemplate+: { resources+: { limits+: limits } } } },
        '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
        withRequests(requests): { spec+: { workVolumeClaimTemplate+: { resources+: { requests: requests } } } },
        '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
        withRequestsMixin(requests): { spec+: { workVolumeClaimTemplate+: { resources+: { requests+: requests } } } },
      },
      '#withAccessModes':: d.fn(help='', args=[d.arg(name='accessModes', type=d.T.array)]),
      withAccessModes(accessModes): { spec+: { workVolumeClaimTemplate+: { accessModes: if std.isArray(v=accessModes) then accessModes else [accessModes] } } },
      '#withAccessModesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='accessModes', type=d.T.array)]),
      withAccessModesMixin(accessModes): { spec+: { workVolumeClaimTemplate+: { accessModes+: if std.isArray(v=accessModes) then accessModes else [accessModes] } } },
      '#withStorageClassName':: d.fn(help='', args=[d.arg(name='storageClassName', type=d.T.string)]),
      withStorageClassName(storageClassName): { spec+: { workVolumeClaimTemplate+: { storageClassName: storageClassName } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
