    ...
    template: {
      ...
      spec: {
        ...
        containers: {
          ...
          '#securityContext':: d.obj(help='"Security options the pod should run with. More info: https://kubernetes.io/docs/concepts/policy/security-context/ More info: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/"'),
          securityContext: {
        ...
        ephemeralContainers: {
          ...
          '#securityContext':: d.obj(help='"SecurityContext is not allowed for ephemeral containers."'),
          securityContext: {
            '#capabilities':: d.obj(help='"The capabilities to add/drop when running containers. Defaults to the default set of capabilities granted by the container runtime."'),
            capabilities: {
              '#withAdd':: d.fn(help='"Added capabilities"', args=[d.arg(name='add', type=d.T.array)]),
